...
switch (yytype)
    ...
    Parser (FlexScanner* scanner_yyarg, int* result_yyarg);
    virtual ~Parser ();
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_OP_SUBS ()
      {
        return symbol_type (token::OP_SUBS);
      }
#else
      static
      symbol_type
      ...
      make_OP_DIVISION ()
      {
        return symbol_type (token::OP_DIVISION);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_PARENTHESES_LEFT ()
      {
        return symbol_type (token::PARENTHESES_LEFT);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_PARENTHESES_RIGHT ()
      {
        return symbol_type (token::PARENTHESES_RIGHT);
      }
#else
      static
      symbol_type
      ...
      make_BRACKET_LEFT ()
      {
        return symbol_type (token::BRACKET_LEFT);
      }
#else
      static
      symbol_type
      ...
      make_BRACKET_RIGHT ()
      {
        return symbol_type (token::BRACKET_RIGHT);
      }
#else
      static
      symbol_type
      ...
      make_BRACES_LEFT ()
      {
        return symbol_type (token::BRACES_LEFT);
      }
#else
      static
      symbol_type
      ...
      make_BRACES_RIGHT ()
      {
        return symbol_type (token::BRACES_RIGHT);
      }
#else
      static
      symbol_type
